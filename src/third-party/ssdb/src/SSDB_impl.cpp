...
Status ClientImpl::hgetall(const std::string& name, std::vector<std::string>* ret) {
  const std::vector<std::string>* resp;
...
Status ClientImpl::zrange(const std::string& name, uint64_t offset, uint64_t limit, std::vector<std::string>* ret) {
...
Status ClientImpl::zrrange(const std::string& name, uint64_t offset, uint64_t limit, std::vector<std::string>* ret) {
  std::string s_offset = str(offset);
  std::string s_limit = str(limit);
  const std::vector<std::string>* resp;
...
Status ClientImpl::zkeys(const std::string& name,
                         const std::string& key_start,
                         int64_t* score_start,
                         int64_t* score_end,
                         uint64_t limit,
...
Status ClientImpl::zscan(const std::string& name,
                         const std::string& key_start,
                         int64_t* score_start,
                         int64_t* score_end,
                         uint64_t limit,
...
Status ClientImpl::zrscan(const std::string& name,
                          const std::string& key_start,
                          int64_t* score_start,
                          int64_t* score_end,
                          uint64_t limit,
...
Status ClientImpl::multi_zset(const std::string& name, const std::map<std::string, int64_t>& kss) {
  ...
  for (std::map<std::string, int64_t>::const_iterator it = kss.begin(); it != kss.end(); ++it) {
...
Status ClientImpl::qslice(const std::string& name, int64_t begin, int64_t end, std::vector<std::string>* ret) {
