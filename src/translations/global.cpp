...
const QString trPleaseEnterYourPassword = QObject::tr("Please enter your password.");
const QString trLogin = QObject::tr("Login");
const QString trPleaseEnterYourLogin = QObject::tr("Please enter your login.");
...
const QString trRefresh = QObject::tr("Refresh");
...
const QString trLoadSettingsFromFile = QObject::tr("Load settings from file");
...
const QString trCloseOthers = QObject::tr("Close Others");
...
const QString trPublishSubscribe = QObject::tr("Publish/Subscribe");
const QString trClientsMonitor = QObject::tr("Clients monitor");
...
const QString trViewKeys = QObject::tr("View keys");
