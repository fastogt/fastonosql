...
MemcachedConnectionSettings::MemcachedConnectionSettings(const connection_path_t& connectionName)
...
Config MemcachedConnectionSettings::info() const {
  return info_;
}

void MemcachedConnectionSettings::setInfo(const Config &info) {
  info_ = info;
}
