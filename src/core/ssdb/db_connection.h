...
class DBConnection
  : public core::DBConnection<NativeConnection, Config, SSDB>, public CommandHandler {
 public:
  ...
  common::Error hkeys(const std::string& name, const std::string& key_start,
                      const std::string& key_end, uint64_t limit, std::vector<std::string>* ret) WARN_UNUSED_RESULT;
  ...
  common::Error multi_zdel(const std::string& name, const std::vector<std::string> &keys) WARN_UNUSED_RESULT;
...
static const std::vector<CommandHolder> ssdbCommands = {
  CommandHolder("AUTH", "<password>",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &auth),
  ...
  CommandHolder("SETX", "<key> <value> <ttl>",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &setx),
  ...
  CommandHolder("INCR", "<key> [num]",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 1, &incr),
  ...
  CommandHolder("SCAN", "<key_start> <key_end> <limit>",
              "List keys in range (key_start, key_end].",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &scan),
  CommandHolder("RSCAN", "<key_start> <key_end> <limit>",
              "List keys in range (key_start, key_end].",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &rscan),
  CommandHolder("MULTI_GET", "<keys>",
              "Get the values related to the specified multiple keys",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &multi_get),
  CommandHolder("MULTI_SET", "<kvs>",
              "Set multiple key-value pairs(kvs) in one method call.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &multi_set),
  CommandHolder("MULTI_DEL", "<keys>",
              "Delete specified multiple keys.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &multi_del),
  CommandHolder("HSET", "<name> <key> <value>",
              "Set the string value in argument as value of the key of a hashmap.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &hset),
  CommandHolder("HGET", "<name> <key>",
              "Get the value related to the specified key of a hashmap",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &hget),
  CommandHolder("HDEL", "<name> <key>",
              "Delete specified key of a hashmap.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &hdel),
  CommandHolder("HINCR", "<name> <key> <num>",
              "Increment the number stored at key in a hashmap by num.\n"
              "The num argument could be a negative integer.\n"
              "The old number is first converted to an integer before increment, assuming it was stored as literal integer.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &hincr),
  CommandHolder("HSIZE", "<name>",
              "Return the number of pairs of a hashmap.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &hsize),
  CommandHolder("HCLEAR", "<name>",
              "Delete all keys in a hashmap.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &hclear),
  ...
  CommandHolder("HRSCAN", "<name> <key_start> <key_end> <limit>",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 4, 0, &hrscan),
  CommandHolder("MULTI_HGET", "<name> <keys>",
              "Get the values related to the specified multiple keys of a hashmap.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &multi_hget),
  CommandHolder("MULTI_HSET", "<name> <kvs>",
              "Set multiple key-value pairs(kvs) of a hashmap in one method call.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &multi_hset),
  CommandHolder("ZSET", "<name> <key> <score>",
              "Set the score of the key of a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 4, 0, &zset),
  CommandHolder("ZGET", "<name> <key>",
              "Get the score related to the specified key of a zset",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &zget),
  CommandHolder("ZDEL", "<name> <key>",
              "Delete specified key of a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &zdel),
  CommandHolder("ZINCR", "<name> <key> <num>",
              "Increment the number stored at key in a zset by num.\n"
              "The num argument could be a negative integer.\n"
              "The old number is first converted to an integer before increment, assuming it was stored as literal integer.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &zincr),
  CommandHolder("ZSIZE", "<name>",
              "Return the number of pairs of a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &zsize),
  CommandHolder("ZCLEAR", "<name>",
              "Delete all keys in a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 1, 0, &zclear),
  CommandHolder("ZRANK", "<name> <key>",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &zrank),
  CommandHolder("ZRRANK", "<name> <key>",
              "Returns the rank(index) of a given key in the specified sorted set, starting at 0 for the item with the smallest score.\n"
              "zrrank starts at 0 for the item with the largest score.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &zrrank),
  CommandHolder("ZRANGE", "<name> <offset> <limit>",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &zrange),
  CommandHolder("ZRRANGE", "<name> <offset> <limit>",
              "Returns a range of key-score pairs by index range [offset, offset + limit). Zrrange iterates in reverse order.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &zrrange),
  CommandHolder("ZKEYS", "<name> <key_start> <score_start> <score_end> <limit>",
              "List keys in a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 4, 0, &zkeys),
  CommandHolder("ZSCAN", "<name> <key_start> <score_start> <score_end> <limit>",
             ...
             "and keys larger than key_start also with score equal to score_start will be returned.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 5, 0, &zscan),
  CommandHolder("ZRSCAN", "<name> <key_start> <score_start> <score_end> <limit>",
              "List key-score pairs of a zset, in reverse order.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 5, 0, &zrscan),
  CommandHolder("MULTI_ZGET", "<name> <keys>",
              "Get the values related to the specified multiple keys of a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &multi_zget),
  CommandHolder("MULTI_ZSET", "<name> <kvs>",
              "Set multiple key-score pairs(kvs) of a zset in one method call.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &multi_zset),
  CommandHolder("MULTI_ZDEL", "<name> <keys>",
              "Delete specified multiple keys of a zset.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &multi_zdel),
  CommandHolder("INFO", "[opt]",
              "Return information about the server.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 0, 1, &info),
  CommandHolder("QPUSH", "<name> <item>",
              "Adds an or more than one element to the end of the queue.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &qpush),
  CommandHolder("QPOP", "<name> <size>",
              "Pop out one or more elements from the head of a queue.",
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 2, 0, &qpop),
  CommandHolder("QSLICE", "<name> <begin> <end>",
              ...
              UNDEFINED_SINCE, UNDEFINED_EXAMPLE_STR, 3, 0, &qslice),
