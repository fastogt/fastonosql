...
Driver::Driver(IConnectionSettingsBaseSPtr settings)
  ...
  COMPILE_ASSERT(core::rocksdb::DBConnection::GetConnectionType() == core::ROCKSDB,
...
core::FastoObjectCommandIPtr Driver::CreateCommand(core::FastoObject* parent,
  ...
  return proxy::CreateCommand<rocksdb::Command>(parent, input, logging_type);
}

core::FastoObjectCommandIPtr Driver::CreateCommandFast(const core::command_buffer_t& input,
                                                       core::CmdLoggingType logging_type) {
  return proxy::CreateCommandFast<rocksdb::Command>(input, logging_type);
}
