...
#include <fastonosql/core/db/dynomite_redis/config.h>  // for Config
...
class ConnectionSettings : public IConnectionSettingsRemoteSSH {
 public:
  ...
  core::dynomite_redis::Config GetInfo() const;
  void SetInfo(const core::dynomite_redis::Config& info);
 ...
 private:
  core::dynomite_redis::Config info_;
};
